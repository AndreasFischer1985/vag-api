...
from deutschland.vag import rest
from deutschland.vag.configuration import Configuration
from deutschland.vag.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.vag.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AbfahrtenApi()
        api_instance.abfahrten_get1  # this is an instance of the class Endpoint
        api_instance.abfahrten_get1()  # this invokes api_instance.abfahrten_get1.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.abfahrten_get1.callable or self.callable in this class
